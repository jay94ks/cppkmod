...
#ifndef HEADERS_MODCPP_DEVICE_NETWORK_PACKET_TYPE_T_HPP_
#define HEADERS_MODCPP_DEVICE_NETWORK_PACKET_TYPE_T_HPP_
...
KMOD_FORWARD void ptt_pack(struct packet_type* pt, struct packet_type_t* ptt);
KMOD_FORWARD void ptt_unpack(struct packet_type_t* ptt, struct packet_type* pt);
...
#endif /* HEADERS_MODCPP_DEVICE_NETWORK_PACKET_TYPE_T_HPP_ */
